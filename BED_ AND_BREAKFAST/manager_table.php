...
<body>
    <div class="container">
        <h2 style="text-align: center; font-family: century; font-weight: bold;">MANAGER PLATFORM </h2>
        <h4 style="text-align: center; font-family: century; font-weight: bold;">LIST OF MANAGER IN OUR WEBSITE</h4>
        <a href="manager_form.html" class="btn btn-primary" style="margin-top: 0px;">New Manager</a>
